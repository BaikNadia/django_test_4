...
from .views import BooksListView, BookDetailView, BookCreateView, BookUpdateView, BookDeleteView, AuthorCreateView, \
...
urlpatterns = [
    ...
    path('recommend/<int:pk>/', RecommendBookView.as_view(), name='book_recommend'),
    path('review/<int:pk>/', ReviewBookView.as_view(), name='book_review'),
]
